...
<html>
  <head>
    ...
    <script type="text/javascript" src="../../../localhost/js/redirectOnBook.js">
    ...
    <script type="text/javascript" src="../../../localhost/js/loadBooks.js">
     ...
     <script type="text/javascript" src="../../../localhost/js/sortBooks.js">
    </script>
    
    <script type="text/javascript" src="../../../localhost/js/getSubject.js">
  ...
  <body>
    ...
    <section class="main">
        ...
        <section class="objectOfBook">
            
        </section>
        
        <section class="underlineLib">
